...
| `/oral-history-projects` | 구술 사업 (서가) | 국내 구술채록 사업 56건을 **ISAD(G) 계열 기술 라벨이 붙은 상자**로 세우고, 갈래마다 선반 하나를 준다. 상자를 누르면 그 상자가 첫 자리로 나오며 옆에 기술지가 펴진다. 화면 맨 아래에는 같은 56건을 눕힌 **기록물 대장**이 있다(아래 참고) |
