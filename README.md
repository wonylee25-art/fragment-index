...
- **수집 범위**([scripts/fetch-riss-papers.mjs](scripts/fetch-riss-papers.mjs) 참고) — 학위논문은 "구술사"+"구술생애사" 정확검색 합집합(교육/종교/스포츠 계열 기관 제외), 학술논문은 "구술사"+"구술생애사"+"생애사" 정확검색 합집합 중 제목에 "구술"이나 "생애사"가 들어가고 발행 학술지·학회가 인문·사회·복합학 계열인 것입니다. 예술체육·의약학·공학·종교 계열에 더해 **사회복지·특수교육·평생교육 계열 지면도 받지 않습니다**(2026-08-20) — 다만 제목에 "구술"이 들어간 논문은 지면과 무관하게 받습니다(체육 계열은 제외). 『구술사연구』(한국구술사학회지)·한국구술사학회 학술대회 발행물은 조건과 무관하게 다 받습니다.
